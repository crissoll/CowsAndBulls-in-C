#define HELP_CMD_HELP                                                          \
  "help\n"                                                                     \
  "  Print this help message with all available commands and usage "           \
  "examples.\n"                                                                \
  "  Usage: help\n\n"
...
#define HELP_CMD_ATTEMPTS                                                      \
  ...
  "  Useful to analyze which past results are compatible with a candidate "    \
  "word.\n"                                                                    \
...
#define HELP_CMD_LIST                                                          \
  "list <pattern>\n"                                                           \
  "  Start or reset the list filter and keep only words that match "           \
  "<pattern>.\n"                                                               \
  "  Pattern rules:\n"                                                         \
  "  - Exactly 5 chars for positional filtering (example: a**de).\n"           \
  "  - Use '*' for unknown letters.\n"                                         \
  "  - A single letter (example: e) means words containing that letter "       \
  "anywhere.\n"                                                                \
  "  Usage: list a**de\n"                                                      \
  "         list e\n"                                                          \
  "\n"                                                                         \
