...
void io__shutdown() { free(output_buffer); }

/* Internal: expose to cab_output for print_to_buffer */
char **cab_io__get_output_buffer_ptr(void) { return &output_buffer; }

size_t *cab_io__get_output_buffer_size_ptr(void) { return &output_buffer_size; }
...
const char *cab_io__get_input_buffer(void) { return input_buffer; }

size_t cab_io__get_input_buffer_size(void) { return input_buffer_size; }
